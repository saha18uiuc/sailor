...
def get_additional_state(iteration):
    """ Gets extra stage for checkpointing """
    args = get_args()
    state_dict = {}
...
def save_checkpoint(iteration, model, optimizer, opt_param_scheduler):
    ...
    print(f"deepspeed is {args.deepspeed}, args.use_distributed_optimizer is {args.use_distributed_optimizer}")
