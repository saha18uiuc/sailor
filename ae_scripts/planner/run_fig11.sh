...
mkdir -p /root/sailor/ae_results/planner/fig11
...
--gpus-per-node 4 \
--sailor_path /root \
--res_dir ae_results/planner/fig11 \
--objective iteration_cost \
--min_throughput_file ae_scripts/planner/min_throughput_file.json  \
--baselines cost
