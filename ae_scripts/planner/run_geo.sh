...
mkdir -p /root/sailor/ae_results/planner/fig10

python ae_scripts/planner/run_all_sim.py \
--model-name OPT-350 \
--gpu-type A100-40 \
--trace_file /root/sailor/sailor/Planner/simulations/configs/gpu_trace_multizone.csv \
...
--gpus-per-node 4 \
--sailor_path /root \
--res_dir ae_results/planner/fig10 \
