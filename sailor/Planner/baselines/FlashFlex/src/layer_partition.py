...
def adjust_by_memory(quota, memories, strategy, configs):
    memory_check = []
    memory_view = []
...
def create_layer_partition(strategy, configs):
    """
    ...
    quota, memory_view = adjust_by_memory(quota, memories, strategy, configs)
