...
def _opt(num_layers, init_method, output_layer_init_method, num_tokentypes, parallel_output, hidden_dropout, hidden_size, ffn_hidden_size, num_attention_heads, kv_channels):
    op_list = []
...
class FlexOPTModel(MegatronModule):
    def __init__(self,
                 num_tokentypes=0,
        ...
        super(FlexOPTModel, self).__init__()
        args = get_args()
        ...
        if not profiling:
            ...
            full_op_list = _opt(num_layers, init_method, output_layer_init_method, num_tokentypes, parallel_output, \
            ...
            output_layer_init_method = scaled_init_method_normal(args.init_method_std, num_layers)
            self.full_op_list = _opt(num_layers, init_method, output_layer_init_method, num_tokentypes, parallel_output, \
