...
def parse_args(extra_args_provider=None, defaults={},
    ...
    if args.model_name in ["gpt", "OPT-350", "OPT-30", "GPT-Neo-2.7"]:
...
def _add_training_args(parser):
    ...
    group.add_argument('--training-config-json', type=str, required=False,
                       help='Read training config from this path.')
