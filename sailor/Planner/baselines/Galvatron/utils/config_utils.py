...
def strategy2config(strategy_list):
    ...
    tp_sizes_enc = [s[1] for s in strategy_list]
    dp_sizes_enc = [s[2] for s in strategy_list]
    ...
    config = {"pp_deg":pp_deg, "tp_sizes_enc":tp_sizes_enc, "dp_sizes_enc": dp_sizes_enc, "tp_consecutive_flags":tp_consecutive_flags, "dp_types_enc":dp_types_enc}
    return config
