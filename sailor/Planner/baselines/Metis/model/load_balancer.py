...
if TYPE_CHECKING:
    from sailor.Planner.baselines.Metis.search_space.plan import InterStagePlan
    ...
    def _get_stage_memory_demand(self, layer_partition: List[int], strategies: List[Tuple[int, int]],
        ...
        for stage_id, strategy in enumerate(strategies):
            ...
            if len(set(cur_device_types)) == 1:
                ...
                hetero_bs = [bs] * dp_deg #data_load_balancer.partition_data(device_types, strategy, gbs // batches)
