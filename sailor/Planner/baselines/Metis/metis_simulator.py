...
class MetisSimulator():
    def __init__(self, profile_file: str, cluster_config: dict, training_config: dict) -> None:
        ...
        with open(f"{home_dir}/elastic-spot-ml/sailor/providers/gcp/intra_node_bandwidths.json", 'r') as f:
            self.intra_network_config = json.load(f)

        with open(f"{home_dir}/elastic-spot-ml/sailor/providers/gcp/multizone_bandwidths.json", 'r') as f:
